...
const Fournisseur = ({ collectionName, fieldNames }) => {
 ...
 useEffect(() => {
  ...
  const GetRempli = async () => {
    try {
      const reponse = await axios.get(
        `http://server.jcloud-ver-jpe.ik-server.com/api/fournisseur/${collect}`
      );
  ...
  const handleReSave = async (event) => {
    ...
    try {
      const response = await axios.post("http://server.jcloud-ver-jpe.ik-server.com/api/fournisseur/resave", {
        data: updateDatascop,
  ...
  const handleDelete = async() =>{
    try {
      const response = await axios.post("http://server.jcloud-ver-jpe.ik-server.com/api/fournisseur/deleteId", {
